                ...
                <div className=" white-bg border-radius-sm modal-wrapper">
                    ...
                    <div className="modal-body padding-lg">
                        ...
                        <div className="margin-top-lg flex align-center">
                            <Button type="button" disabled={props.serviceStore.serviceAddLoading || (!props.serviceStore.serviceadd.name)}  onClick= { ()=>{props.serviceStore.handleServiceAdd()}} text="Add" type={AppConstant.POSITIVE} />
                        </div>
                    </div>
                </div>
            </Modal>
