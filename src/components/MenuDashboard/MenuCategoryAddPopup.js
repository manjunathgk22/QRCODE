...
const MenuCategoryAddPopup = (props) => {
    return (
        <Observer>
            {()=>(
                <Modal onOverlayClick={()=>{props.menuStore.showMenuCategoryAddPopup = false}}>
            <div className=" white-bg border-radius-sm modal-wrapper">
                <div className="flex space-between padding-bottom-sm padding-lg border-bottom">
                    ...
                    <span style={{fontSize:22}} className="pointer" onClick={()=>{props.menuStore.showMenuCategoryAddPopup = false}}>X</span>
                </div>
...
export default MenuCategoryAddPopup;