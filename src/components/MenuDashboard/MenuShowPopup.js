                ...
                <div className=" white-bg border-radius-sm modal-wrapper">
                    ...
                    <div className="modal-body padding-lg">
                        ...
                        <div className="margin-top-lg flex align-center">
                            <Button type="button" disabled={props.menuStore.menuAddLoading || (!props.menuStore.menuadd.name)}  onClick= { ()=>{props.menuStore.handleMenu(true)}} text="Add" type={AppConstant.POSITIVE} />
                        </div>
                    </div>
                </div>
            </Modal>
